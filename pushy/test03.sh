...
# ==============================================================================
# Test the pushy-commit with a invalid message length empty.
#
...
# Create a file with any message
echo "testwithvalidmessage" > a
...
if diff "$expected_output" "$actual_output" > /dev/null; then
    echo "Test03 (invalid commit message length): Passed"
else
    echo "Test03 (invalid commit message length): Failed"
fi
