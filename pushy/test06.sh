...
# ==============================================================================
# Test the pushy-show command with no .pushy repository.
#
...
echo "pushy-show: error: pushy repository directory .pushy not found" > "$expected_output"

# Compare the expected and actual outputs
if diff "$expected_output" "$actual_output" > /dev/null; then
    echo "Test06 (pushy-show invalid pushy repository): Passed"
else
    echo "Test06 (pushy-show invalid pushy repository): Failed"
fi
